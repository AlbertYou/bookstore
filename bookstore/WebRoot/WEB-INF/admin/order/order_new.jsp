...
<html>
	<head>
    	...
    	<title>新订单-<%=getServletContext().getServletContextName()%></title>
	...
	<body>
		<div id="page">
			...
			<div id="content">
				<div id="left">
					<ul id="left_nav">
						<li id="current_left_nav"><a href="ordersnew.action">新订单</a></li>
				...
				<div id="right">
					<div id="order_panel">
						<div id="temp_nav">
							<span id="order_total">尚未发货的订单(共<s:property value="#request.orders.allRecords"/>笔)</span>
							<span id="order_sort">按购买时间升序排列</span>
						</div>
						<ul id="order_list">
							<s:iterator id="order" value="#request.orders.list">
								<li class="order_detail">
									...
									<div class="order_delivery">
										<span>合计：<span id="total_price_label">￥<s:property value="#order.totalPrice"/></span></span>
										<span><a href="deliver.action?orderId=<s:property value="#order.orderId"/>">发货</a></span>
									</div>
								</li>
							</s:iterator>
						</ul>
