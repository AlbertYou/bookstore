...
<html>
	<head>
    	...
    	<title>待发货订单-<%=getServletContext().getServletContextName()%></title>
			...
			<div id="content">
			  <div id="left">
					<div id="nav_panel">
						...
						<div class="current_nav"><a href="undeliveredorderlist.action">待发货</a></div>
              ...
              <div id="right">
				<div id="temp_nav">
					<span id="order_total">待发货订单(<s:property value="#request.orders.size"/>笔)</span>
