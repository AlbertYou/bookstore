...
<html>
	<head>
    	...
    	<title>新书推荐-<%=getServletContext().getServletContextName()%></title>
			  ...
			  <div id="breadcrumb">
				...
				<div id="pagepanel">
				  <s:if test="#request.books.allRecords > 0">
					...
					<s:else>
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index - 1"/>">上一页</a>
					</s:else>
					
					<s:if test="#request.page_index - 3 > 0">
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index - 3"/>"><s:property value="#request.page_index - 3"/></a>
					</s:if>
					<s:if test="#request.page_index - 2 > 0">
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index - 2"/>"><s:property value="#request.page_index - 2"/></a>
					</s:if>
					<s:if test="#request.page_index - 1 > 0">
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index - 1"/>"><s:property value="#request.page_index - 1"/></a>
					</s:if>
					<span id="current_page_label">
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index"/>"><s:property value="#request.page_index"/></a>
					</span>
					...
					<s:if test="#request.page_index - 2 <= 0 && #request.page_index + 4 <= #request.books.allPages">
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index + 4"/>"><s:property value="#request.page_index + 4"/></a>
					</s:if>
					<s:if test="#request.page_index - 1 <= 0 && #request.page_index + 5 <= #request.books.allPages">
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index + 5"/>"><s:property value="#request.page_index + 5"/></a>
					</s:if>
					...
					<s:else>
						<a href="newbooklist.action?page_index=<s:property value="#request.page_index + 1"/>">下一页</a>
					</s:else>&nbsp;&nbsp;
