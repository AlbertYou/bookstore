...
<html>
	<head>
    	...
    	<title>${requestScope.category.name }-<%=getServletContext().getServletContextName()%></title>
    	<script type="text/javascript" src="../js/jquery-1.6.2.min.js"></script>
    	<script type="text/javascript" src="../js/gotop.js"></script>
    	<link rel="stylesheet" type="text/css" href="../style/user/book/book_category.css">
	</head>
	<body>
<div id="page">
			<div id="header">
			...
			<div id="content">
			  <div id="breadcrumb">&nbsp;&nbsp;
				    <span>
				    	分类&nbsp;<s:property value="#request.category.parent.name"/>&nbsp;&gt;&nbsp;<s:property value="#request.category.name"/>&nbsp;中有
				    	<s:property value="#request.books.allRecords"/>件商品
				    </span>
			  </div>
			  <div id="left">
              ...
              <div id="right">
				...
				<div id="pagepanel">
				  <s:if test="#request.books.allRecords > 0">
					...
					<s:else>
						<a href="categorybooks.action?page_index=<s:property value="#request.page_index - 1"/>&categoryId=<s:property value="#request.category.categoryId"/>">上一页</a>
					</s:else>
					
					<s:if test="#request.page_index - 3 > 0">
						<a href="categorybooks.action?page_index=<s:property value="#request.page_index - 3"/>&categoryId=<s:property value="#request.category.categoryId"/>"><s:property value="#request.page_index - 3"/></a>
					</s:if>
					<s:if test="#request.page_index - 2 > 0">
						<a href="categorybooks.action?page_index=<s:property value="#request.page_index - 2"/>&categoryId=<s:property value="#request.category.categoryId"/>"><s:property value="#request.page_index - 2"/></a>
					</s:if>
					<s:if test="#request.page_index - 1 > 0">
						<a href="categorybooks.action?page_index=<s:property value="#request.page_index - 1"/>&categoryId=<s:property value="#request.category.categoryId"/>"><s:property value="#request.page_index - 1"/></a>
					</s:if>
					<a href="categorybooks.action?page_index=<s:property value="#request.page_index"/>&categoryId=<s:property value="#request.category.categoryId"/>"><s:property value="#request.page_index"/></a>
					...
					<s:if test="#request.page_index - 2 <= 0 && #request.page_index + 4 <= #request.books.allPages">
						<a href="categorybooks.action?page_index=<s:property value="#request.page_index + 4"/>&categoryId=<s:property value="#request.category.categoryId"/>"><s:property value="#request.page_index + 4"/></a>
					</s:if>
					<s:if test="#request.page_index - 1 <= 0 && #request.page_index + 5 <= #request.books.allPages">
						<a href="categorybooks.action?page_index=<s:property value="#request.page_index + 5"/>&categoryId=<s:property value="#request.category.categoryId"/>"><s:property value="#request.page_index + 5"/></a>
					</s:if>
					...
					<s:else>
						<a href="categorybooks.action?page_index=<s:property value="#request.page_index + 1"/>&categoryId=<s:property value="#request.category.categoryId"/>">下一页</a>
					</s:else>&nbsp;&nbsp;
					<span>共<s:property value="#request.books.allPages"/>页</span>&nbsp;
					<span>到第</span>
					<s:hidden id="categoryId" value="%{#request.category.categoryId }"></s:hidden>
