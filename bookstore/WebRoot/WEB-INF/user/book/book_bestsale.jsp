...
<html>
	<head>
    	...
    	<title>图书销售排行-<%=getServletContext().getServletContextName()%></title>
			  ...
			  <div id="breadcrumb">
				...
				<div id="pagepanel">
				  <s:if test="#request.books.allRecords > 0">
					...
					<s:else>
						<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index - 1"/>">上一页</a>
					</s:else>
					
					<s:if test="#request.page_index - 3 > 0">
						<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index - 3"/>"><s:property value="#request.page_index - 3"/></a>
					</s:if>
					<s:if test="#request.page_index - 2 > 0">
						<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index - 2"/>"><s:property value="#request.page_index - 2"/></a>
					</s:if>
					<s:if test="#request.page_index - 1 > 0">
						<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index - 1"/>"><s:property value="#request.page_index - 1"/></a>
					</s:if>
					<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index"/>"><s:property value="#request.page_index"/></a>
					...
					<s:if test="#request.page_index - 2 <= 0 && #request.page_index + 4 <= #request.books.allPages">
						<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index + 4"/>"><s:property value="#request.page_index + 4"/></a>
					</s:if>
					<s:if test="#request.page_index - 1 <= 0 && #request.page_index + 5 <= #request.books.allPages">
						<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index + 5"/>"><s:property value="#request.page_index + 5"/></a>
					</s:if>
					...
					<s:else>
						<a href="bestsalebookList.action?page_index=<s:property value="#request.page_index + 1"/>">下一页</a>
					</s:else>&nbsp;&nbsp;
