			...
			<div id="content">
			  <div id="left">
					<div id="nav_panel">
						...
						<div class="current_nav"><a href="recipientlist.action">收货地址管理</a></div>
              ...
              <div id="right">
				...
				<div id="recipient_form">
					...
					<div id="form_title">新增收货地址</div>
						<ul id="recipient_form_label">
							<s:if test="#request.notice != null && #request.notice == 'error'">
								<li>
									<p style="font-size: 20px;color: red;text-align: center;padding-top: 10px;">
										增加失败，已拥有大量的收货地址，请先删除不需要的收货地址
									</p>
								</li>
							</s:if>
							<li><p>收货人姓名：</p></li>
						...
						<ul id="recipient_form_input">
							<li><p><input name="recipient" type="text"/><span class="required_warn">*</span></p></li>
							<li><textarea rows="3" cols="40" name="address"/></textarea><span class="required_warn">*</span></li>
							<li><p><input name="zipcode" type="text"/><span class="required_warn">*</span></p></li>
							<li><p><input name="phone" type="text"/></p></li>
							<li><p><input name="defaultAddr" type="checkbox" value="1"/></p></li>
