 ...
 *
 */
public class GoodBookListAction extends UserAction {
	private static final long serialVersionUID = 7143961258362851539L;
	...
	public String execute() throws Exception {
		...
		List<Book> list = bookService.findGoodBooks((page_index - 1) * books.getRecordInPage(), books.getRecordInPage());
		books.setList(list);
