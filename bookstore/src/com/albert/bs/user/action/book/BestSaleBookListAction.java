 ...
 *
 */
public class BestSaleBookListAction extends UserAction {
	private static final long serialVersionUID = 3814734556131125038L;
	...
	public String execute() throws Exception {
		...
		List<Book> list = bookService.findBooksBySale((page_index - 1) * books.getRecordInPage(), books.getRecordInPage());
		books.setList(list);
